...
export const MAIN_AXES: CapabilityAxis[] = [
  ...
  },
  {
    ...
    technologies: ["Node.js", "Express", "Go", "Firebase", "JWT", "C#", ".NET"],
    projects: ["EtecNotes API", "DailyFlow API", "Sistema de Autenticação", "API de Upload"],
    achievements: [
      "API com autenticação JWT + RBAC",
      "API própria em Go para o DailyFlow",
  ...
  },
  {
    ...
    technologies: ["Firebase", "Supabase", "PostgreSQL", "MySQL", "MongoDB", "Firestore"],
    projects: ["EtecNotes Database", "DailyFlow Database", "Sistema de Dados"],
    achievements: [
  ...
  },
  {
    ...
    technologies: ["Vercel", "Docker", "Render", "Neon", "Git", "GitHub", "Linux", "Azure"],
    projects: ["EtecNotes Deploy", "DailyFlow Deploy", "CI/CD Pipeline"],
    achievements: [
      "Deploy em produção automatizado",
      "Containerização com Docker e deploy no Render",
