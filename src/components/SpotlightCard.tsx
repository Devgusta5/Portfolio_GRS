...
export function SpotlightCard({
  ...
  return (
    <Comp
      ...
      className={`spotlight-card group relative overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] transition-colors duration-300 hover:border-[var(--border-2)] ${className}`}
      style={style}
    >
      <div
